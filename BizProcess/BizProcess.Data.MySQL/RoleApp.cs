...
{
    public class RoleApp : BizProcess.Data.Interface.IRoleApp
    {
        ...
        public int Add(BizProcess.Data.Model.RoleApp model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Title", MySqlDbType.VarChar, 200){ Value = model.Title },
				...
				model.Ico == null ? new MySqlParameter("@Ico", MySqlDbType.VarChar, 200) { Value = DBNull.Value } : new MySqlParameter("@Ico", MySqlDbType.VarChar, 200) { Value = model.Ico },
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.RoleApp> GetAll()
        {
            string sql = "SELECT * FROM RoleApp";
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.RoleApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.RoleApp Get(Guid id)
        {
        ...
        /// 查询一个角色所有记录
        /// </summary>
        public List<BizProcess.Data.Model.RoleApp> GetAllByRoleID(Guid roleID)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<BizProcess.Data.Model.RoleApp> GetChild(Guid id)
        {
        ...
        {
            string sql = "SELECT ID FROM RoleApp WHERE ParentID=@ParentID LIMIT 0,1";
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@ParentID", MySqlDbType.VarChar){ Value = id }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
