...
{
    public class WorkFlowComment : BizProcess.Data.Interface.IWorkFlowComment
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.WorkFlowComment实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(BizProcess.Data.Model.WorkFlowComment model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Comment", MySqlDbType.VarChar, 500){ Value = model.Comment },
        ...
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.WorkFlowComment实体类</param>
        public int Update(BizProcess.Data.Model.WorkFlowComment model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowComment> DataReaderToList(MySqlDataReader dataReader)
        {
            List<BizProcess.Data.Model.WorkFlowComment> List = new List<BizProcess.Data.Model.WorkFlowComment>();
            BizProcess.Data.Model.WorkFlowComment model = null;
            while (dataReader.Read())
            {
                model = new BizProcess.Data.Model.WorkFlowComment();
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowComment> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowComment";
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.WorkFlowComment> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.WorkFlowComment Get(Guid id)
        {
        ...
        /// 查询管理员的所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowComment> GetManagerAll()
        {
