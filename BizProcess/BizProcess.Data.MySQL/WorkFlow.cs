    ...
    public class WorkFlow : BizProcess.Data.Interface.IWorkFlow
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlow model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@Manager", MySqlDbType.VarChar, 5000){ Value = model.Manager },
				new MySqlParameter("@InstanceManager", MySqlDbType.VarChar, 5000){ Value = model.InstanceManager },
				...
				model.RunJSON == null ? new MySqlParameter("@RunJSON", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@RunJSON", MySqlDbType.Text, -1) { Value = model.RunJSON },
