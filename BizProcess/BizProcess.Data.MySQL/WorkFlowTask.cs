...
{
    public class WorkFlowTask : BizProcess.Data.Interface.IWorkFlowTask
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.WorkFlowTask实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(BizProcess.Data.Model.WorkFlowTask model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@PrevID", MySqlDbType.VarChar, -1){ Value = model.PrevID },
				new MySqlParameter("@PrevStepID", MySqlDbType.VarChar, -1){ Value = model.PrevStepID },
				...
				new MySqlParameter("@Title", MySqlDbType.VarChar, 2000){ Value = model.Title },
				new MySqlParameter("@SenderID", MySqlDbType.VarChar, -1){ Value = model.SenderID },
				new MySqlParameter("@SenderName", MySqlDbType.VarChar, 50){ Value = model.SenderName },
				new MySqlParameter("@SenderTime", MySqlDbType.DateTime, 8){ Value = model.SenderTime },
				new MySqlParameter("@ReceiveID", MySqlDbType.VarChar, -1){ Value = model.ReceiveID },
				new MySqlParameter("@ReceiveName", MySqlDbType.VarChar, 50){ Value = model.ReceiveName },
				new MySqlParameter("@ReceiveTime", MySqlDbType.DateTime, 8){ Value = model.ReceiveTime },
				model.OpenTime == null ? new MySqlParameter("@OpenTime", MySqlDbType.DateTime, 8) { Value = DBNull.Value } : new MySqlParameter("@OpenTime", MySqlDbType.DateTime, 8) { Value = model.OpenTime },
				model.CompletedTime == null ? new MySqlParameter("@CompletedTime", MySqlDbType.DateTime, 8) { Value = DBNull.Value } : new MySqlParameter("@CompletedTime", MySqlDbType.DateTime, 8) { Value = model.CompletedTime },
				model.CompletedTime1 == null ? new MySqlParameter("@CompletedTime1", MySqlDbType.DateTime, 8) { Value = DBNull.Value } : new MySqlParameter("@CompletedTime1", MySqlDbType.DateTime, 8) { Value = model.CompletedTime1 },
				model.Comment == null ? new MySqlParameter("@Comment", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@Comment", MySqlDbType.Text, -1) { Value = model.Comment },
				model.IsSign == null ? new MySqlParameter("@IsSign", MySqlDbType.Int32, -1) { Value = DBNull.Value } : new MySqlParameter("@IsSign", MySqlDbType.Int32, -1) { Value = model.IsSign },
				...
				model.SubFlowGroupID == null ? new MySqlParameter("@SubFlowGroupID", MySqlDbType.VarChar, -1) { Value = DBNull.Value } : new MySqlParameter("@SubFlowGroupID", MySqlDbType.VarChar, -1) { Value = model.SubFlowGroupID }
			};
        ...
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.WorkFlowTask实体类</param>
        public int Update(BizProcess.Data.Model.WorkFlowTask model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowTask> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowTask";
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.WorkFlowTask Get(Guid id)
        {
        ...
        public int Delete(Guid flowID, Guid groupID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID }
			};
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public void UpdateOpenTime(Guid id, DateTime openTime, bool isStatus = false)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                openTime==DateTime.MinValue? new MySqlParameter("@OpenTime", MySqlDbType.DateTime){ Value = DBNull.Value} :
                    new MySqlParameter("@OpenTime", MySqlDbType.DateTime){ Value = openTime },
				new MySqlParameter("@ID", MySqlDbType.VarChar){ Value = id }
			};
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetTasks(Guid userID, out string pager, string query="", string title="", string flowid="", string sender="", string date1="", string date2="", int type=0)
        {
            List<MySqlParameter> parList = new List<MySqlParameter>();
            StringBuilder sql = new StringBuilder("SELECT * FROM WorkFlowTask WHERE ReceiveID=@ReceiveID");
            sql.Append(type == 0 ? " AND Status IN(0,1)" : " AND Status IN(2,3)");
            parList.Add(new MySqlParameter("@ReceiveID", MySqlDbType.VarChar) { Value = userID });
            if (!title.IsNullOrEmpty())
            {
                sql.Append(" AND LOCATE(@Title,Title)>0");
                parList.Add(new MySqlParameter("@Title", MySqlDbType.VarChar, 2000) { Value = title });
            }
            if (flowid.IsGuid())
            {
                sql.Append(" AND FlowID=@FlowID");
                parList.Add(new MySqlParameter("@FlowID", MySqlDbType.VarChar) { Value = flowid.ToGuid() });
            }
            else if (!flowid.IsNullOrEmpty() && flowid.IndexOf(',') >= 0)
            {
                sql.Append(" AND FlowID IN(" + BizProcess.Utility.Tools.GetSqlInString(flowid) + ")");
            }
            if (sender.IsGuid())
            {
                sql.Append(" AND SenderID=@SenderID");
                parList.Add(new MySqlParameter("@SenderID", MySqlDbType.VarChar) { Value = sender.ToGuid() });
            }
            if (date1.IsDateTime())
            {
                sql.Append(" AND ReceiveTime>=@ReceiveTime");
                parList.Add(new MySqlParameter("@ReceiveTime", MySqlDbType.DateTime) { Value = date1.ToDateTime().Date });
            }
            if (date2.IsDateTime())
            {
                sql.Append(" AND ReceiveTime<=@ReceiveTime1");
                parList.Add(new MySqlParameter("@ReceiveTime1", MySqlDbType.DateTime) { Value = date1.ToDateTime().AddDays(1).Date });
            }
            sql.Append(" ORDER BY " + (type == 0 ? "ReceiveTime DESC" : "CompletedTime1 DESC"));
            ...
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql1, parList.ToArray());
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetInstances(Guid[] flowID, Guid[] senderID, Guid[] receiveID, out string pager, string query = "", string title = "", string flowid = "", string date1 = "", string date2 = "", int status = 0)
        {
            List<MySqlParameter> parList = new List<MySqlParameter>();
            StringBuilder sql = new StringBuilder(@"SELECT a.* FROM WorkFlowTask a
                WHERE a.ID=(SELECT TOP 1 ID FROM WorkFlowTask WHERE FlowID=a.FlowID AND GroupID=a.GroupID ORDER BY Sort DESC) ORDER BY a.SenderTime DESC");
            ...
            {
                sql.Append(string.Format(" AND a.FlowID IN({0})", BizProcess.Utility.Tools.GetSqlInString(flowID)));
            }
            if (senderID != null && senderID.Length > 0)
            {
                if (senderID.Length == 1)
                {
                    ...
                    parList.Add(new MySqlParameter("@SenderID", MySqlDbType.VarChar) { Value = senderID[0] });
                }
                else
                {
                    sql.Append(string.Format(" AND a.SenderID IN({0})", BizProcess.Utility.Tools.GetSqlInString(senderID)));
                }
            }
            if (receiveID != null && receiveID.Length > 0)
            {
                if (senderID.Length == 1)
                {
                    ...
                    parList.Add(new MySqlParameter("@ReceiveID", MySqlDbType.VarChar) { Value = receiveID[0] });
                }
                else
                {
                    sql.Append(string.Format(" AND a.ReceiveID IN({0})", BizProcess.Utility.Tools.GetSqlInString(receiveID)));
                }
            }
            if (!title.IsNullOrEmpty())
            {
                sql.Append(" AND LOCATE(@Title,a.Title)>0");
                parList.Add(new MySqlParameter("@Title", MySqlDbType.VarChar, 2000) { Value = title });
            }
            if (flowid.IsGuid())
            {
            ...
            {
                sql.Append(" AND a.FlowID IN(" + BizProcess.Utility.Tools.GetSqlInString(flowid) + ")");
            }
            if (date1.IsDateTime())
            {
                sql.Append(" AND a.SenderTime>=@SenderTime");
                parList.Add(new MySqlParameter("@SenderTime", MySqlDbType.DateTime) { Value = date1.ToDateTime().Date });
            }
            if (date2.IsDateTime())
            {
                sql.Append(" AND a.SenderTime<=@SenderTime1");
                parList.Add(new MySqlParameter("@SenderTime1", MySqlDbType.DateTime) { Value = date1.ToDateTime().AddDays(1).Date });
            }
        ...
        public Guid GetFirstSnderID(Guid flowID, Guid groupID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID },
                new MySqlParameter("@PrevID", MySqlDbType.VarChar){ Value = Guid.Empty }
			};
        ...
        public List<Guid> GetStepSnderID(Guid flowID, Guid stepID, Guid groupID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = stepID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID }
			};
        ...
        public int Completed(Guid taskID, string comment = "", bool isSign = false, int status = 2, string note="")
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				comment.IsNullOrEmpty() ? new MySqlParameter("@Comment", MySqlDbType.Text){ Value = DBNull.Value } : new MySqlParameter("@Comment", MySqlDbType.Text){ Value = comment },
                new MySqlParameter("@CompletedTime1", MySqlDbType.DateTime){ Value = BizProcess.Utility.DateTimeNew.Now },
                new MySqlParameter("@IsSign", MySqlDbType.Int32){ Value = isSign?1:0 },
                new MySqlParameter("@Status", MySqlDbType.Int32){ Value = status },
                note.IsNullOrEmpty()?new MySqlParameter("@Note", MySqlDbType.Text){ Value = DBNull.Value }:new MySqlParameter("@Note", MySqlDbType.Text){ Value = note },
                new MySqlParameter("@ID", MySqlDbType.VarChar){ Value = taskID }
			};         
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public int UpdateNextTaskStatus(Guid taskID, int status)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@Status", MySqlDbType.Int32){ Value = status },
                new MySqlParameter("@PrevID", MySqlDbType.VarChar){ Value = taskID }
			};
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public List<Model.WorkFlowTask> GetUserTaskList(Guid flowID, Guid stepID, Guid groupID, Guid userID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                ...
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = stepID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID },
                new MySqlParameter("@ReceiveID", MySqlDbType.VarChar){ Value = userID }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskList(Guid flowID, Guid groupID)
        {
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskList(Guid taskID)
        {
            var task = Get(taskID);
            if (task == null)
            {
            ...
            string sql = "SELECT * FROM WorkFlowTask WHERE PrevID=@PrevID AND StepID=@StepID";
            MySqlParameter[] parameters1 = new MySqlParameter[]{
                new MySqlParameter("@PrevID", MySqlDbType.VarChar){ Value = task.PrevID },
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = task.StepID }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters1);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        ...
        {
            string sql = "SELECT ID FROM WorkFlowTask WHERE FlowID=@FlowID AND StepID=@StepID AND GroupID=@GroupID AND ReceiveID=@ReceiveID AND Status IN(0,1) LIMIT 0,1";
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@FlowID", MySqlDbType.VarChar){ Value = flowID },
                new MySqlParameter("@StepID", MySqlDbType.VarChar){ Value = stepID },
                new MySqlParameter("@GroupID", MySqlDbType.VarChar){ Value = groupID },
        ...
        public int GetTaskStatus(Guid taskID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@ID", SqlDbType.VarChar){ Value = taskID }
			};
        ...
        public List<Model.WorkFlowTask> GetBySubFlowGroupID(Guid subflowGroupID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
                new MySqlParameter("@SubFlowGroupID", MySqlDbType.VarChar){ Value = subflowGroupID }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
