...
namespace BizProcess.Data.MySQL
{
    ...
    public class DBHelper
    {
        ...
        public DBHelper()
        {
            this.connectionString = BizProcess.Utility.Config.PlatformConnectionStringMySQL;
        }
        ...
        public string GetPaerSql(string sql, int size, int number, out long count, MySqlParameter[] param = null)
        {
            ...
            if (count > size)
            {
                sql1.AppendFormat(" where 1 limit {0}, {1}", number * size - size, size);
            }
        ...
        public string GetPaerSql(string table, string fileds, string where, string order, int size, int number, out long count, MySqlParameter[] param = null)
        {
            ...
            string sql = string.Format("select {0} from {2} {3} order by {1}", fileds, order, table, where2);
