...
{
    public class WorkFlowForm : BizProcess.Data.Interface.IWorkFlowForm
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlowForm model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				new MySqlParameter("@CreateUserName", MySqlDbType.VarChar, 50){ Value = model.CreateUserName },
				...
				model.Attribute == null ? new MySqlParameter("@Attribute", MySqlDbType.Text, -1) { Value = DBNull.Value } : new MySqlParameter("@Attribute", MySqlDbType.Text, -1) { Value = model.Attribute },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowForm> DataReaderToList(MySqlDataReader dataReader)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowForm> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowForm";
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.WorkFlowForm> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.WorkFlowForm Get(Guid id)
        {
        ...
        /// 查询一个分类所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowForm> GetAllByType(string types)
        {
            string sql = "SELECT * FROM WorkFlowForm where Type IN(" + BizProcess.Utility.Tools.GetSqlInString(types) + ")";
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.WorkFlowForm> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
