    ...
    public class WorkFlowDelegation : BizProcess.Data.Interface.IWorkFlowDelegation
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlowDelegation model)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				...
				model.Note == null ? new MySqlParameter("@Note", MySqlDbType.VarChar, 4000) { Value = DBNull.Value } : new MySqlParameter("@Note", MySqlDbType.VarChar, 4000) { Value = model.Note }
			};
        ...
        public List<BizProcess.Data.Model.WorkFlowDelegation> GetByUserID(Guid userID)
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@UserID", SqlDbType.UniqueIdentifier){ Value = userID }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
        ...
        public List<BizProcess.Data.Model.WorkFlowDelegation> GetNoExpiredList()
        {
            ...
            MySqlParameter[] parameters = new MySqlParameter[]{
				new MySqlParameter("@EndTime", MySqlDbType.DateTime){ Value = BizProcess.Utility.DateTimeNew.Now }
			};
            MySqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
