...
namespace BizProcess.Data.MSSQL
{
    public class WorkFlowDelegation : BizProcess.Data.Interface.IWorkFlowDelegation
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowDelegation> DataReaderToList(SqlDataReader dataReader)
        {
        ...
        public List<BizProcess.Data.Model.WorkFlowDelegation> GetNoExpiredList()
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]{
				new SqlParameter("@EndTime", SqlDbType.DateTime){ Value = BizProcess.Utility.DateTimeNew.Now }
			};
            SqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
