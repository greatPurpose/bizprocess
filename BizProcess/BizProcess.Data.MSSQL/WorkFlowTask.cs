...
namespace BizProcess.Data.MSSQL
{
    public class WorkFlowTask : BizProcess.Data.Interface.IWorkFlowTask
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowTask> DataReaderToList(SqlDataReader dataReader)
        {
        ...
        public int Completed(Guid taskID, string comment = "", bool isSign = false, int status = 2, string note="")
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]{
                ...
                new SqlParameter("@CompletedTime1", SqlDbType.DateTime){ Value = BizProcess.Utility.DateTimeNew.Now },
        ...
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskList(Guid taskID)
        {
            ...
            SqlParameter[] parameters1 = new SqlParameter[]{
                ...
                new SqlParameter("@StepID", SqlDbType.UniqueIdentifier){ Value = task.StepID }
			};
