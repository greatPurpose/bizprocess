...
namespace BizProcess.Data.Oracle
{
    public class Dictionary : BizProcess.Data.Interface.IDictionary
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.Dictionary> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        public BizProcess.Data.Model.Dictionary GetRoot()
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				new OracleParameter(":ParentID", OracleDbType.Char){ Value = Guid.Empty }
			};
            OracleDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.Dictionary> List = DataReaderToList(dataReader);
            dataReader.Close();
