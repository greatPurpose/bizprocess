    ...
    public class WorkFlowForm : BizProcess.Data.Interface.IWorkFlowForm
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlowForm model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":CreateTime", OracleDbType.Date){ Value = model.CreateTime },
				new OracleParameter(":LastModifyTime", OracleDbType.Date){ Value = model.LastModifyTime },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowForm> DataReaderToList(OracleDataReader dataReader)
        {
