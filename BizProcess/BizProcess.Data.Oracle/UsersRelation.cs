...
{
    public class UsersRelation : BizProcess.Data.Interface.IUsersRelation
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.UsersRelation实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(BizProcess.Data.Model.UsersRelation model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":OrganizeID", OracleDbType.Char, 36){ Value = model.OrganizeID },
        ...
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.UsersRelation实体类</param>
        public int Update(BizProcess.Data.Model.UsersRelation model)
        {
        ...
        public int Delete(Guid userid, Guid organizeid)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":OrganizeID", OracleDbType.Char){ Value = organizeid }
			};
            return dbHelper.Execute(sql, parameters);
        }
        /// <summary>
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.UsersRelation> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersRelation> GetAll()
        {
            string sql = "SELECT * FROM UsersRelation";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.UsersRelation> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.UsersRelation Get(Guid userid, Guid organizeid)
        {
        ...
        /// 查询一个岗位下所有记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersRelation> GetAllByOrganizeID(Guid organizeID)
        {
        ...
        /// 查询一个用户所有记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersRelation> GetAllByUserID(Guid userID)
        {
        ...
        /// 查询一个用户主要岗位
        /// </summary>
        public BizProcess.Data.Model.UsersRelation GetMainByUserID(Guid userID)
        {
