    ...
    public class WorkFlowTask : BizProcess.Data.Interface.IWorkFlowTask
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlowTask model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":PrevID", OracleDbType.Char, 36){ Value = model.PrevID },
				new OracleParameter(":PrevStepID", OracleDbType.Char, 36){ Value = model.PrevStepID },
				...
				new OracleParameter(":SenderID", OracleDbType.Char, 36){ Value = model.SenderID },
				new OracleParameter(":SenderName", OracleDbType.NVarchar2, 100){ Value = model.SenderName },
				new OracleParameter(":SenderTime", OracleDbType.Date){ Value = model.SenderTime },
				new OracleParameter(":ReceiveID", OracleDbType.Char, 36){ Value = model.ReceiveID },
				new OracleParameter(":ReceiveName", OracleDbType.NVarchar2, 100){ Value = model.ReceiveName },
				new OracleParameter(":ReceiveTime", OracleDbType.Date){ Value = model.ReceiveTime },
				model.OpenTime == null ? new OracleParameter(":OpenTime", OracleDbType.Date) { Value = DBNull.Value } : new OracleParameter(":OpenTime", OracleDbType.Date) { Value = model.OpenTime },
				model.CompletedTime == null ? new OracleParameter(":CompletedTime", OracleDbType.Date) { Value = DBNull.Value } : new OracleParameter(":CompletedTime", OracleDbType.Date) { Value = model.CompletedTime },
				model.CompletedTime1 == null ? new OracleParameter(":CompletedTime1", OracleDbType.Date) { Value = DBNull.Value } : new OracleParameter(":CompletedTime1", OracleDbType.Date) { Value = model.CompletedTime1 },
				model.Comment == null ? new OracleParameter(":Comment", OracleDbType.Clob) { Value = DBNull.Value } : new OracleParameter(":Comment", OracleDbType.Clob) { Value = model.Comment },
				...
				model.SubFlowGroupID == null ? new OracleParameter(":SubFlowGroupID", OracleDbType.Char, 36) { Value = DBNull.Value } : new OracleParameter(":SubFlowGroupID", OracleDbType.Char, 36) { Value = model.SubFlowGroupID }
			};
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlowTask> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        public int Delete(Guid flowID, Guid groupID)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				new OracleParameter(":FlowID", OracleDbType.Char){ Value = flowID },
                new OracleParameter(":GroupID", OracleDbType.Char){ Value = groupID }
			};
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public List<BizProcess.Data.Model.WorkFlowTask> GetTasks(Guid userID, out string pager, string query="", string title="", string flowid="", string sender="", string date1="", string date2="", int type=0)
        {
            ...
            StringBuilder sql = new StringBuilder("SELECT WorkFlowTask.*,ROWNUM AS PagerAutoRowNumber FROM WorkFlowTask WHERE ReceiveID=:ReceiveID");
            sql.Append(type == 0 ? " AND Status IN(0,1)" : " AND Status IN(2,3)");
            parList.Add(new OracleParameter(":ReceiveID", OracleDbType.Char) { Value = userID });
            ...
            if (flowid.IsGuid())
            {
                ...
                parList.Add(new OracleParameter(":FlowID", OracleDbType.Char) { Value = flowid.ToGuid() });
            }
            ...
            if (sender.IsGuid())
            {
                ...
                parList.Add(new OracleParameter(":SenderID", OracleDbType.Char) { Value = sender.ToGuid() });
            }
            if (date1.IsDateTime())
            {
            ...
            if (date2.IsDateTime())
            {
                ...
                parList.Add(new OracleParameter(":ReceiveTime1", OracleDbType.Date) { Value = date1.ToDateTime().AddDays(1).Date });
            }
        ...
        {
            List<OracleParameter> parList = new List<OracleParameter>();
            StringBuilder sql = new StringBuilder(@"SELECT a.*,ROWNUM AS PagerAutoRowNumber FROM WorkFlowTask a
                WHERE a.ID=(SELECT ID FROM WorkFlowTask WHERE FlowID=a.FlowID AND GroupID=a.GroupID AND ROWNUM=1 ORDER BY Sort DESC)");
            ...
            if (senderID != null && senderID.Length > 0)
            {
                if (senderID.Length == 1)
                {
                    ...
                    parList.Add(new OracleParameter(":SenderID", OracleDbType.Char) { Value = senderID[0] });
                }
                else
                {
            ...
            if (receiveID != null && receiveID.Length > 0)
            {
                if (senderID.Length == 1)
                {
                    ...
                    parList.Add(new OracleParameter(":ReceiveID", OracleDbType.Char) { Value = receiveID[0] });
                }
                else
                {
            ...
            if (!title.IsNullOrEmpty())
            {
                sql.Append(" AND INSTR(a.Title,:Title)>0");
                parList.Add(new OracleParameter(":Title", OracleDbType.NVarchar2, 2000) { Value = title });
            }
            if (flowid.IsGuid())
            {
            ...
            sql.Append(" ORDER BY a.SenderTime DESC");
        ...
        public Guid GetFirstSnderID(Guid flowID, Guid groupID)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				new OracleParameter(":FlowID", OracleDbType.Char){ Value = flowID },
                new OracleParameter(":GroupID", OracleDbType.Char){ Value = groupID },
                new OracleParameter(":PrevID", OracleDbType.Char){ Value = Guid.Empty }
			};
        ...
        public List<Guid> GetStepSnderID(Guid flowID, Guid stepID, Guid groupID)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				new OracleParameter(":FlowID", OracleDbType.Char){ Value = flowID },
                new OracleParameter(":StepID", OracleDbType.Char){ Value = stepID },
                new OracleParameter(":GroupID", OracleDbType.Char){ Value = groupID }
			};
        ...
        public int Completed(Guid taskID, string comment = "", bool isSign = false, int status = 2, string note="")
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				comment.IsNullOrEmpty() ? new OracleParameter(":Comment", OracleDbType.Clob){ Value = DBNull.Value } : new OracleParameter(":Comment", OracleDbType.Clob){ Value = comment },
                new OracleParameter(":CompletedTime1", OracleDbType.Date){ Value = BizProcess.Utility.DateTimeNew.Now },
                new OracleParameter(":IsSign", OracleDbType.Int32){ Value = isSign?1:0 },
                new OracleParameter(":Status", OracleDbType.Int32){ Value = status },
                note.IsNullOrEmpty()?new OracleParameter(":Note", OracleDbType.NClob){ Value = DBNull.Value }:new OracleParameter(":Note", OracleDbType.NClob){ Value = note },
                new OracleParameter(":ID", OracleDbType.Char){ Value = taskID }
			};         
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public int UpdateNextTaskStatus(Guid taskID, int status)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
                new OracleParameter(":Status", OracleDbType.Int32){ Value = status },
                new OracleParameter(":PrevID", OracleDbType.Char){ Value = taskID }
			};
            return dbHelper.Execute(sql, parameters);
        }
        ...
        public List<Model.WorkFlowTask> GetUserTaskList(Guid flowID, Guid stepID, Guid groupID, Guid userID)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
                ...
                new OracleParameter(":StepID", OracleDbType.Char){ Value = stepID },
                new OracleParameter(":GroupID", OracleDbType.Char){ Value = groupID },
                new OracleParameter(":ReceiveID", OracleDbType.Char){ Value = userID }
			};
            OracleDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
        ...
        public List<BizProcess.Data.Model.WorkFlowTask> GetTaskList(Guid taskID)
        {
            ...
            OracleParameter[] parameters1 = new OracleParameter[]{
                new OracleParameter(":PrevID", OracleDbType.Char){ Value = task.PrevID },
                new OracleParameter(":StepID", OracleDbType.Char){ Value = task.StepID }
			};
        ...
        public List<Model.WorkFlowTask> GetBySubFlowGroupID(Guid subflowGroupID)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
                new OracleParameter(":SubFlowGroupID", OracleDbType.Char){ Value = subflowGroupID }
			};
            OracleDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<BizProcess.Data.Model.WorkFlowTask> List = DataReaderToList(dataReader);
            dataReader.Close();
