...
namespace BizProcess.Data.Oracle
{
    public class Users : BizProcess.Data.Interface.IUsers
    {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.Users> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        public bool HasAccount(string account, string userID = "")
        {
            ...
            {
                sql += " and ID<>:ID";
                plist.Add(new OracleParameter(":ID", OracleDbType.Char) { Value = userID.ToGuid() });
            }
