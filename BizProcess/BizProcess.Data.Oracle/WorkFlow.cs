...
{
    public class WorkFlow : BizProcess.Data.Interface.IWorkFlow
    {
        ...
        public int Add(BizProcess.Data.Model.WorkFlow model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":Manager", OracleDbType.Clob){ Value = model.Manager },
				new OracleParameter(":InstanceManager", OracleDbType.Clob){ Value = model.InstanceManager },
				new OracleParameter(":CreateDate", OracleDbType.Date){ Value = model.CreateDate },
				new OracleParameter(":CreateUserID", OracleDbType.Char, 36){ Value = model.CreateUserID },
				...
				model.InstallDate == null ? new OracleParameter(":InstallDate", OracleDbType.Date) { Value = DBNull.Value } : new OracleParameter(":InstallDate", OracleDbType.Date) { Value = model.InstallDate },
				model.InstallUserID == null ? new OracleParameter(":InstallUserID", OracleDbType.Char, 36) { Value = DBNull.Value } : new OracleParameter(":InstallUserID", OracleDbType.Char, 36) { Value = model.InstallUserID },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkFlow> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        public List<BizProcess.Data.Model.WorkFlow> GetAll()
        {
            ...
            List<BizProcess.Data.Model.WorkFlow> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        {
            string sql = "SELECT * FROM WorkFlow where Type IN(" + BizProcess.Utility.Tools.GetSqlInString(typeString) + ")";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.WorkFlow> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
