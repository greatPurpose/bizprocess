    ...
    public class WorkGroup : BizProcess.Data.Interface.IWorkGroup
    {
        ...
        public int Add(BizProcess.Data.Model.WorkGroup model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
				...
				new OracleParameter(":Members", OracleDbType.Varchar2){ Value = model.Members },
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.WorkGroup> DataReaderToList(OracleDataReader dataReader)
        {
