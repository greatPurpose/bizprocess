...
{
    public class Log : BizProcess.Data.Interface.ILog
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.Log实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(BizProcess.Data.Model.Log model)
        {
            ...
            OracleParameter[] parameters = new OracleParameter[]{
                ...
                new OracleParameter(":Title", OracleDbType.NVarchar2, 500){ Value = model.Title },
                new OracleParameter(":Type", OracleDbType.NVarchar2, 50){ Value = model.Type },
                new OracleParameter(":WriteTime", OracleDbType.Date){ Value = model.WriteTime },
                model.UserID == null ? new OracleParameter(":UserID", OracleDbType.Char, 36) { Value = DBNull.Value } : new OracleParameter(":UserID", OracleDbType.Char, 36) { Value = model.UserID },
                model.UserName == null ? new OracleParameter(":UserName", OracleDbType.NVarchar2, 50) { Value = DBNull.Value } : new OracleParameter(":UserName", OracleDbType.NVarchar2, 50) { Value = model.UserName },
        ...
        /// </summary>
        /// <param name="model">BizProcess.Data.Model.Log实体类</param>
        public int Update(BizProcess.Data.Model.Log model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<BizProcess.Data.Model.Log> DataReaderToList(OracleDataReader dataReader)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.Log> GetAll()
        {
            string sql = "SELECT * FROM Log";
            OracleDataReader dataReader = dbHelper.GetDataReader(sql);
            List<BizProcess.Data.Model.Log> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public BizProcess.Data.Model.Log Get(Guid id)
        {
        ...
        public DataTable GetPagerData(out string pager, string query = "", int size = 15, int number = 1, string title = "", string type = "", string date1 = "", string date2 = "", string userID = "")
        {
            ...
            if (!title.IsNullOrEmpty())
            {
                ...
                parList.Add(new OracleParameter(":Title", OracleDbType.NClob) { Value = title });
            }
