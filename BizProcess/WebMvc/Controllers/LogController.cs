...
namespace WebMvc.Controllers
{
    public class LogController : MyController
    {
        ...
        public ActionResult Index(FormCollection collection)
        {
            ...
            BizProcess.Platform.Log blog = new BizProcess.Platform.Log();
        ...
        public string GetData()
        {
            ...
            string data = BizProcess.Utility.Tools.DataTableToJsonString(dt);
        ...
        public ActionResult Detail()
        {
            ...
            if (id.IsGuid())
            {
                return View(new BizProcess.Platform.Log().Get(id.ToGuid()));
            }
            else
            {
                return View(new BizProcess.Data.Model.Log());
            }
        }
    }
}
