...
namespace WebMvc.Controllers
{
    public class HomeController : MyController
    {
        ...
        { 
            ...
            {
                return new BizProcess.Platform.RoleApp().GetRoleAppJsonString(gid, uid, Url.Content("~/").TrimEnd('/'));
            }
        }
        ...
        { 
            ...
            {
                return new BizProcess.Platform.RoleApp().GetRoleAppRefreshJsonString(gid, uid, refreshid, Url.Content("~/").TrimEnd('/'));
            }
        }
