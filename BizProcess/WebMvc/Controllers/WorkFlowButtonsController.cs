...
namespace WebMvc.Controllers
{
    public class WorkFlowButtonsController : MyController
    {
        ...
        public ActionResult Index(FormCollection collection)
        {
            ...
            IEnumerable<BizProcess.Data.Model.WorkFlowButtons> workFlowButtonsList;
                ...
                if (!Request.Form["DeleteBut"].IsNullOrEmpty())
                {
                    ...
                    foreach (string id in ids.Split(','))
                    {
                        ...
                        if (but != null)
                        {
                            ...
                            BizProcess.Platform.Log.Add("删除了流程按钮", but.Serialize(), BizProcess.Platform.Log.Types.流程相关);
                        }
                    }
