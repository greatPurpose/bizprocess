...
namespace WebMvc.Controllers
{
    public class UserAppController : MyController
    {
        ...
        public string TreeRefresh()
        {
            ...
            BizProcess.Platform.RoleApp BRoleApp = new BizProcess.Platform.RoleApp();
            BizProcess.Platform.UsersApp BUsersApp = new BizProcess.Platform.UsersApp();
        ...
        public ActionResult Body()
        {
            ...
            if (roleApp == null)
            {
                roleApp = new BizProcess.Data.Model.RoleApp();
            }
            ViewBag.AppID = appid;
        ...
        public ActionResult AddApp(FormCollection collection)
        {
            ...
            BizProcess.Platform.UsersApp busersApp = new BizProcess.Platform.UsersApp();
            BizProcess.Platform.RoleApp broleApp = new BizProcess.Platform.RoleApp();
            BizProcess.Data.Model.UsersApp usersApp = null;
            ...
            if (collection != null && id.IsGuid() && userID.IsGuid())
            {
                ...
                if (!Request.Form["Save"].IsNullOrEmpty())
                {
                    ...
                    BizProcess.Data.Model.UsersApp usersApp1 = new BizProcess.Data.Model.UsersApp();
                    ...
                    BizProcess.Platform.Log.Add("添加了个人应用", busersApp.Serialize(), BizProcess.Platform.Log.Types.角色应用);
                    string refreshID = id;
        ...
        public ActionResult Body1(FormCollection collection)
        {
            BizProcess.Platform.AppLibrary bappLibrary = new BizProcess.Platform.AppLibrary();
            BizProcess.Platform.RoleApp broleApp = new BizProcess.Platform.RoleApp();
            BizProcess.Platform.UsersApp buserApp = new BizProcess.Platform.UsersApp();
            BizProcess.Data.Model.UsersApp usersApp = null;
            ...
            if (collection != null && usersApp != null)
            {
                if (!Request.Form["Save"].IsNullOrEmpty())
                {
                    ...
                    buserApp.ClearCache();
                    BizProcess.Platform.Log.Add("修改了个人应用", "", BizProcess.Platform.Log.Types.角色应用, oldXML, usersApp.Serialize());
                ...
                if (!Request.Form["Delete"].IsNullOrEmpty())
                {
                    ...
                    buserApp.ClearCache();
                    BizProcess.Platform.Log.Add("删除了个人应用", usersApp.Serialize(), BizProcess.Platform.Log.Types.角色应用);
                    string refreshID = usersApp.ParentID.ToString();
            ...
            ViewBag.AppID = appid;
            ViewBag.AppTypesOptions = bappLibrary.GetTypeOptions(type);
            return View(usersApp == null ? new BizProcess.Data.Model.UsersApp() : usersApp);
        }
