...
namespace WebMvc.Controllers
{
    public class MembersController : MyController
    {
        ...
        public ActionResult Sort(FormCollection collection)
        {
            ...
            var orgs = new BizProcess.Platform.Organize().GetChilds(parentid.ToGuid());
            return View(orgs);
        }
        ...
        public string GetPy()
        {
            ...
            return account.IsNullOrEmpty() ? "" : new BizProcess.Platform.Users().GetAccount(account.Trim());
        }
        ...
        public string CheckAccount()
        {
            ...
            return new BizProcess.Platform.Users().HasAccount(account, id) ? "帐号已经被使用了" : "1";
        }
