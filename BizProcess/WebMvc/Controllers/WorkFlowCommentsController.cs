...
namespace WebMvc.Controllers
{
    public class WorkFlowCommentsController : MyController
    {
        ...
        {
            BizProcess.Platform.WorkFlowComment bworkFlowComment = new BizProcess.Platform.WorkFlowComment();
            BizProcess.Platform.Organize borganize = new BizProcess.Platform.Organize();
            IEnumerable<BizProcess.Data.Model.WorkFlowComment> workFlowCommentList;
            ...
            if (isOneSelf)
            {
                workFlowCommentList = workFlowCommentList.Where(p => p.MemberID == BizProcess.Platform.Users.PREFIX + BizProcess.Platform.Users.CurrentUserID.ToString());
            }
        ...
        {
            BizProcess.Platform.WorkFlowComment bworkFlowComment = new BizProcess.Platform.WorkFlowComment();
            BizProcess.Data.Model.WorkFlowComment workFlowComment = null;
            ...
            if (collection != null)
            {
                member = isOneSelf ? BizProcess.Platform.Users.PREFIX + BizProcess.Platform.Users.CurrentUserID.ToString() : Request.Form["Member"];
                ...
                {
                    workFlowComment = new BizProcess.Data.Model.WorkFlowComment();
                ...
                if (isAdd)
                {
                    ...
                    BizProcess.Platform.Log.Add("添加了流程意见", workFlowComment.Serialize(), BizProcess.Platform.Log.Types.流程相关);
                }
                else
                {
                    bworkFlowComment.Update(workFlowComment);
                    BizProcess.Platform.Log.Add("修改了流程意见", "", BizProcess.Platform.Log.Types.流程相关, oldXML, workFlowComment.Serialize());
                }
                bworkFlowComment.RefreshCache();
                ViewBag.Script = "new BPUI.Window().reloadOpener();alert('保存成功!');";
            }
            return View(workFlowComment == null ? new BizProcess.Data.Model.WorkFlowComment() : workFlowComment);
        }
