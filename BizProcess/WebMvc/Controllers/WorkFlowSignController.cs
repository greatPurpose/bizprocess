...
　　　　　　      var file = Request.Files[0];
                if (file.ContentLength > 0)
                {
                    ...
                    string filename = string.Concat(Server.MapPath(Url.Content("~/Content/UserSigns/")), BizProcess.Platform.Users.CurrentUserID, ".gif");
                    file1.SaveAs(filename);
                    BizProcess.Platform.Log.Add("修改了签名", filename, BizProcess.Platform.Log.Types.流程相关);
            ...
            if (!Request.Form["reset"].IsNullOrEmpty())
            {
                ...
                if (System.IO.File.Exists(filename))
                {
                    ...
                    BizProcess.Platform.Log.Add("恢复了签名", filename, BizProcess.Platform.Log.Types.流程相关);
                }
