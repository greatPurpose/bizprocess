...
;BPUI.Window = function ()
{
    ...
    this.getID = function ()
    {
        var id = this.opts.id != null && this.opts.id != undefined && $.trim(this.opts.id).length > 0 ? this.opts.id : "bpui_window_" + Math.random().toString();
    ...
    {
        var amount = 0;
        var $maindiv = !id || id.trim().length == 0 ? $("div[id^='bpui_window_']", top.document) : $("#" + id, top.document);
        ...
        {
            var $maindiv1 = !id || id.trim().length == 0 ? $("div[id^='bpui_window_']", top.frames[i].document) : $("#" + id, top.frames[i].document);
    ...
    this.getOpenerElement = function (id)
    {
        ...
        var openerid = BPUI.Core.query("openerid") || "";
