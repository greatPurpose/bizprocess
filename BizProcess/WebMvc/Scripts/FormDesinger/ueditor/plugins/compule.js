UE.compule = {
    ...
    getRadioOrCheckboxHtml: function ($control, type)
    {
        ...
        else if ("2" == datasource)//SQL
        {
            ...
            if ("radio" == type)
            {
                radios += '<span>@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetRadioFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + id + '", "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_radio\'' + eventArrs + '"))' + eventScripts + '</span>';
            }
            else if ("checkbox" == type)
            {
                radios += '<span>@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetCheckboxFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + id + '", "' + defaultvalue + '", "isflow=\'1\' type1=\'flow_checkbox\'' + eventArrs + '"))' + eventScripts + '</span>';
            }
            $control.after(radios);
            $control.remove();
        }
    ...
    getSelectHtml: function ($control)
    {
        ...
        else if ("2" == datasource)//SQL
        {
            ...
            radios += '@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetOptionsFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + defaultvalue + '"))';
            radios += '</select>';
            var $radios = $(radios);
            $radios.attr("eventsid", $control.attr("eventsid"));
            $control.after($radios);
    ...
    getGridHtml: function ($control)
    {
        ...
        div += '" >';
        div += '@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetFormGridHtml(DBConnID, "' + $control.attr("dataformat") + '","' + $control.attr("datasource") + '","' + $control.attr("datasource1") + '"))';
        div += '</div>';
        $control.after(div);
        $control.remove();
    },
    ...
    getSubTableHtml_Select: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            ...
            case "select_dssql":
                ...
                select += '@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetOptionsFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + dvalue + '"))';
                break;
    ...
    getSubTableHtml_Checkbox: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            ...
            case "checkbox_dssql":
                ...
                checkbox = '@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetCheckboxFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + name + '", "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_checkbox\'" colname=\'' + colnumJSON.name + '\'"))';
                break;
    ...
    getSubTableHtml_Radio: function (colnumJSON, id, i, iscount)
    {
        ...
        switch (ds)
        {
            ...
            case "radio_dssql":
                ...
                radio = '@Html.Raw(new BizProcess.Platform.WorkFlowForm().GetRadioFromSql(DBConnID, "' + sql.replaceAll('"', '\"') + '", "' + name + '", "' + dvalue + '", "issubflow=\'1\' type1=\'subflow_radio\'" colname=\'' + colnumJSON.name + '\'"))';
                break;
            case "radio_dsstring":
