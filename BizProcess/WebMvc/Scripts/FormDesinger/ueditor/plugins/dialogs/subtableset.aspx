...
<% 
    ...
    BizProcess.Platform.WorkFlowForm workFlowFrom = new BizProcess.Platform.WorkFlowForm();
...
<table cellpadding="0" cellspacing="1" border="0" width="98%" style="margin-top:6px;" class="formtable" id="maintable">
    ...
    <tr id="mode_select" style="display:none;">
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <script type="text/javascript">
                new BPUI.Tab({ id: "tabdiv_select", replace: true, contextmenu: false });
            </script>
        </td>
    </tr>
    ...
    <tr id="mode_checkbox" style="display:none;">
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <script type="text/javascript">
                new BPUI.Tab({ id: "tabdiv_checkbox", replace: true, contextmenu: false });
            </script>
        </td>
    </tr>
    ...
    <tr id="mode_radio" style="display:none;">
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <script type="text/javascript">
                new BPUI.Tab({ id: "tabdiv_radio", replace: true, contextmenu: false });
            </script>
        </td>
    </tr>
            ...
            if (jsonstr.length > 0)
            {
                ...
                switch (editmode)
                {
                    ...
                    case "select":
                        ...
                        new BPUI.Dict().setValue($("#select_ds_dict"));
                        break;
                    case "checkbox":
                        ...
                        new BPUI.Dict().setValue($("#checkbox_ds_dict"));
                        break;
                    case "radio":
                        ...
                        new BPUI.Dict().setValue($("#radio_ds_dict"));
                        break;
                    case "datetime":
                    ...
                    case "org":
                        ...
                        new BPUI.Member().setValue($("#org_rang1"));
                    ...
                    case "dict":
                         ...
                         new BPUI.Dict().setValue($("#dict_rang"));
