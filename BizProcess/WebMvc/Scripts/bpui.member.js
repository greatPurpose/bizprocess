        ...
        $members.each(function (index)
        {
            ...
            else
            {
                $but.bind("click", function ()
                {
                    ...
                    new BPUI.Window().open({ id: "member_" + id, url: (top.rootdir || "") + "/Controls/SelectMember/Index?" + params, width: 500, height: 470, resize: false, title: "选择组织机构成员", openerid: BPUI.Core.query("tabid") || "" });
                });
            }
