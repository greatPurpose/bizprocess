...
namespace BizProcess.Data.Model
{
    ...
    public class WorkFlowInstalled
    {
        ...
        /// 调试人员
        /// </summary>
        public List<BizProcess.Data.Model.Users> DebugUsers { get; set; }
...
namespace BizProcess.Data.Model.WorkFlowInstalledSub
{
    /// <summary>
    /// 数据库连接结构体
    /// </summary>
...
namespace BizProcess.Data.Model.WorkFlowInstalledSub.StepSet
{
    /// <summary>
    /// 步骤行为实体
    /// </summary>
