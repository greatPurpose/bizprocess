...
namespace BizProcess.Data.Interface
{
    public interface IRoleApp
    {
        ...
        /// 新增
        /// </summary>
        int Add(BizProcess.Data.Model.RoleApp model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(BizProcess.Data.Model.RoleApp model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<BizProcess.Data.Model.RoleApp> GetAll();
        ...
        /// 查询一个角色所有记录
        /// </summary>
        List<BizProcess.Data.Model.RoleApp> GetAllByRoleID(Guid roleID);
        ...
        /// 查询下级记录
        /// </summary>
        List<BizProcess.Data.Model.RoleApp> GetChild(Guid id);
