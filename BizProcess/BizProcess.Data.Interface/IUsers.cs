...
namespace BizProcess.Data.Interface
{
    public interface IUsers
    {
        ...
        /// 新增
        /// </summary>
        int Add(BizProcess.Data.Model.Users model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(BizProcess.Data.Model.Users model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<BizProcess.Data.Model.Users> GetAll();
        ...
        /// 根据帐号查询一条记录
        /// </summary>
        BizProcess.Data.Model.Users GetByAccount(string account);
