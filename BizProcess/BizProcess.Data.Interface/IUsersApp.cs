...
namespace BizProcess.Data.Interface
{
    public interface IUsersApp
    {
        ...
        /// 新增
        /// </summary>
        int Add(BizProcess.Data.Model.UsersApp model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(BizProcess.Data.Model.UsersApp model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<BizProcess.Data.Model.UsersApp> GetAll();
        ...
        /// 查询下级记录
        /// </summary>
        List<BizProcess.Data.Model.UsersApp> GetChild(Guid id);
