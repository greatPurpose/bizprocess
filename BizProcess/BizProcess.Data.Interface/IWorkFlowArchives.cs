...
namespace BizProcess.Data.Interface
{
    public interface IWorkFlowArchives
    {
        ...
        /// 新增
        /// </summary>
        int Add(BizProcess.Data.Model.WorkFlowArchives model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(BizProcess.Data.Model.WorkFlowArchives model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<BizProcess.Data.Model.WorkFlowArchives> GetAll();
