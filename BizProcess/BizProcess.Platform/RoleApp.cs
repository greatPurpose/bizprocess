...
namespace BizProcess.Platform
{
    ...
    {
        private BizProcess.Data.Interface.IRoleApp dataRoleApp;
        public RoleApp()
        {
        ...
        {
            string key = BizProcess.Utility.Keys.CacheKeys.RoleApp.ToString();
            ...
            if (obj == null || !(obj is System.Data.DataTable))
            {
                ...
                BizProcess.Cache.IO.Opation.Set(key, dt);
                return dt;
            }
            else
            {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.RoleApp> GetAllChild(Guid id)
        {
        ...
        private void addChilds(List<BizProcess.Data.Model.RoleApp> list, Guid id)
        {
            var childs = GetChild(id);
            foreach (var child in childs)
            {
        ...
        private void insertChilds(Guid oldID, Guid newID, Guid roleID, List<BizProcess.Data.Model.RoleApp> apps)
        {
        ...
        /// <param name="roleID"></param>
        /// <returns></returns>
        public BizProcess.Data.Model.RoleApp GetRootByRoleID(Guid roleID)
        {
