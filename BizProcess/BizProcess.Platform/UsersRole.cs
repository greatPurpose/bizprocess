...
namespace BizProcess.Platform
{
    ...
    {
        private static string cacheKey = BizProcess.Utility.Keys.CacheKeys.UserRoles.ToString();
        private BizProcess.Data.Interface.IUsersRole dataUsersRole;
        public UsersRole()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public BizProcess.Data.Model.UsersRole Get(Guid userid, Guid roleid)
        {
        ...
        /// 根据一组用户ID查询记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersRole> GetByUserIDArray(Guid[] memberIDArray)
        {
        ...
        /// 根据用户ID查询记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersRole> GetByUserID(Guid memberID)
        {
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.UsersRole> GetByUserIDFromCache(Guid userID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<BizProcess.Data.Model.UsersRole> GetAllFromCache()
        {
            var obj = BizProcess.Cache.IO.Opation.Get(cacheKey);
            if (obj == null || !(obj is List<BizProcess.Data.Model.UsersRole>))
            {
                var list = GetAll();
            ...
            {
                return obj as List<BizProcess.Data.Model.UsersRole>;
            }
        }
