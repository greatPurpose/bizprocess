...
namespace BizProcess.Platform
{
    public class WorkGroup
    {
        ...
        private BizProcess.Data.Interface.IWorkGroup dataWorkGroup;
        public WorkGroup()
        {
        ...
        public string GetUsersNames(string members, char split = ',')
        {
            ...
            var users = new BizProcess.Platform.Organize().GetAllUsers(members);
        ...
        /// <param name="split"></param>
        /// <returns></returns>
        public string GetUsersNames(BizProcess.Data.Model.WorkGroup wg, char split = ',')
        {
