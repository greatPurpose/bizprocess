...
namespace BizProcess.Platform
{
    public class Role
    {
        private BizProcess.Data.Interface.IRole dataRole;
        public Role()
        {
        ...
        /// <returns></returns>
        public string GetRoleOptions(string value = "", string hideID = "", IEnumerable<BizProcess.Data.Model.Role> roleList = null)
        {
