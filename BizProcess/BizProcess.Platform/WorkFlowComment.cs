...
namespace BizProcess.Platform
{
    ...
    {
        private BizProcess.Data.Interface.IWorkFlowComment dataWorkFlowComment;
        ...
        {
            string key = BizProcess.Utility.Keys.CacheKeys.WorkFlowComments.ToString();
            if (!fromCache)
            {
        ...
        {
            BizProcess.Cache.IO.Opation.Remove(BizProcess.Utility.Keys.CacheKeys.WorkFlowComments.ToString());
        }
        /// <summary>
        /// 刷新缓存
        /// </summary>
        ...
        {
            BizProcess.Cache.IO.Opation.Set(BizProcess.Utility.Keys.CacheKeys.WorkFlowComments.ToString(), getAllListByDb());
        }
        /// <summary>
        /// 得到一个用户的所有意见
        /// </summary>
