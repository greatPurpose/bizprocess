...
namespace BizProcess.Platform
{
    ...
    {
        private BizProcess.Data.Interface.IUsersApp dataUsersApp;
        public UsersApp()
        {
        ...
        {
            string cacheKey = BizProcess.Utility.Keys.CacheKeys.UsersApp.ToString();
            if (fromCache)
            {
                ...
                if (obj == null || !(obj is System.Data.DataTable))
                {
                    ...
                    BizProcess.Cache.IO.Opation.Insert(cacheKey, dt);
                    return dt;
                }
                else
                {
        ...
        /// 查询下级记录
        /// </summary>
        public List<BizProcess.Data.Model.UsersApp> GetChilds(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.UsersApp> GetAllChilds(Guid id)
        {
        ...
        private void addChilds(Guid id, List<BizProcess.Data.Model.UsersApp> list)
        {
