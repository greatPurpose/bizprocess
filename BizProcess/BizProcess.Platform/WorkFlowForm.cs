...
namespace BizProcess.Platform
{
    ...
    public class WorkFlowForm
    {
        ...
        private BizProcess.Data.Interface.IWorkFlowForm dataWorkFlowForm;
		public WorkFlowForm()
		{
        ...
        public string GetValidatePropTypeRadios(string name, string value, string att = "")
        {
            ...
            return BizProcess.Utility.Tools.GetRadioString(items, name, att);
        }
        ...
        public string GetEventOptions(string name, string value, string att = "")
        {
            ...
            return BizProcess.Utility.Tools.GetOptionsString(items);
        }
        ...
        public string GetDefaultValueSelect(string value)
        {
            ...
            options.AppendFormat("<option value=\"u_@(new BizProcess.Platform.WorkFlowTask().GetFirstSnderID(FlowID.ToGuid(), GroupID.ToGuid(), true))\" {0}>流程发起者ID</option>", "14" == value ? "selected=\"selected\"" : "");
        ...
        public string GetOrgSelectTypeCheckboxs(string name, string value, string att = "")
        {
            ...
            return BizProcess.Utility.Tools.GetCheckBoxString(items, name, value.Split(','), att);
        }
        ...
        /// 查询一个分类所有记录
        /// </summary>
        public List<BizProcess.Data.Model.WorkFlowForm> GetAllByType(Guid id)
        {
