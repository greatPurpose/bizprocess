...
namespace BizProcess.Platform
{
    ...
    {
        private string cacheKey = BizProcess.Utility.Keys.CacheKeys.AppLibrary.ToString();
        private BizProcess.Data.Interface.IAppLibrary dataAppLibrary;
        public AppLibrary()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(BizProcess.Data.Model.AppLibrary model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(BizProcess.Data.Model.AppLibrary model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<BizProcess.Data.Model.AppLibrary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            else
            {
                ...
                if (obj != null)
                {
                    return obj as List<BizProcess.Data.Model.AppLibrary>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public BizProcess.Data.Model.AppLibrary Get(Guid id, bool fromCache=false)
        {
            if (!fromCache)
            {
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.AppLibrary> GetPagerData(out string pager, string query = "", string title = "", string type = "", string address = "")
        {
            return dataAppLibrary.GetPagerData(out pager, query, "Type,Title", BizProcess.Utility.Tools.GetPageSize(),
                BizProcess.Utility.Tools.GetPageNumber(), title, type, address);
        }
        /// <summary>
        /// 查询一个类别下所有记录
        /// </summary>
        public List<BizProcess.Data.Model.AppLibrary> GetAllByType(Guid type)
        {
            if (type.IsEmptyGuid())
            {
                return new List<BizProcess.Data.Model.AppLibrary>();
            }
        ...
        /// <returns></returns>
        public string GetFlowRunAddress(BizProcess.Data.Model.AppLibrary app, string query="")
        {
