...
namespace BizProcess.Platform
{
    public class Organize
    {
        ...
        private BizProcess.Data.Interface.IOrganize dataOrganize;
        public Organize()
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.Users> GetAllUsers(Guid id)
        {
        ...
        {
            return number.IsNullOrEmpty() ? new List<BizProcess.Data.Model.Organize>() : dataOrganize.GetAllParent(number);
        }

        /// <summary>
        /// 查询一个组织的所有上级
        /// </summary>
        public List<BizProcess.Data.Model.Organize> GetAllParent(Guid id)
        {
            var org = Get(id);
            if (org == null)
            {
                return new List<BizProcess.Data.Model.Organize>();
            }
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.Organize> GetAllChilds(string number)
        {
            return number.IsNullOrEmpty() ? new List<BizProcess.Data.Model.Organize>() : dataOrganize.GetAllChild(number);
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.Organize> GetAllChilds(Guid id)
        {
            var org = Get(id);
            if (org == null)
            {
