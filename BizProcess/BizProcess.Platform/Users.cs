...
namespace BizProcess.Platform
{
    public class Users
    {
        ...
        private BizProcess.Data.Interface.IUsers dataUsers;
        public Users()
        {
        ...
        {
            return BizProcess.Utility.Config.SystemInitPassword;
        }
        /// <summary>
        /// 得到加密后的密码字符串
        /// </summary>
        ...
        public string EncryptionPassword(string password)
        {
            ...
            BizProcess.Utility.HashEncrypt hash = new BizProcess.Utility.HashEncrypt();
        ...
        /// <returns></returns>
        public List<BizProcess.Data.Model.Users> GetAllByOrganizeID(Guid organizeID)
        {
        ...
        /// <param name="organizeID"></param>
        /// <returns></returns>
        public List<BizProcess.Data.Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public BizProcess.Data.Model.Organize GetDeptByUserID(Guid userID)
        { 
            ...
            var parents = new BizProcess.Platform.Organize().GetAllParent(stationID);
            parents.Reverse();
        ...
        /// 得到当前登录用户
        /// </summary>
        public static BizProcess.Data.Model.Users CurrentUser
        {
            get
            {
                object obj = System.Web.HttpContext.Current.Session[BizProcess.Utility.Keys.SessionKeys.User.ToString()];
                if (obj == null)
                {
                    ...
                    else
                    {
                        ...
                        if (user != null)
                        {
                            System.Web.HttpContext.Current.Session[BizProcess.Utility.Keys.SessionKeys.User.ToString()] = user;
                        }
                        return user;
                    }
                }
                ...
                {
                    return obj as BizProcess.Data.Model.Users;
                }
            }
        }
    ...
    public class UsersEqualityComparer : IEqualityComparer<BizProcess.Data.Model.Users>
    {
        public bool Equals(BizProcess.Data.Model.Users user1, BizProcess.Data.Model.Users user2)
        {
            return user1 == null || user2 == null || user1.ID == user2.ID;
        }
        public int GetHashCode(BizProcess.Data.Model.Users user)
        {
