...
public static class MyExtensions
{
    ...
    {
        return BizProcess.Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return BizProcess.Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return BizProcess.Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return BizProcess.Utility.EncryptionDes.Decrypt(str);
    }
